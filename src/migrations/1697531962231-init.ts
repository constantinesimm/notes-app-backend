...
export class Init1697531962231 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notes" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "body" character varying NOT NULL, "link" character varying, "access_type" "public"."notes_access_type_enum" NOT NULL DEFAULT 'private', "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-17T08:39:29.376Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-17T08:39:29.377Z"', "accessUsersId" integer, CONSTRAINT "PK_af6206538ea96c4e77e9f400c3d" PRIMARY KEY ("id"))`);
